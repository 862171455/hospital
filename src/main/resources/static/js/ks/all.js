layui.use(['layer','table','jquery' ],function(){
    ...
    table.render({
        ...
        ,cols:[[
            {field:"id", align: "center",title:"编号",width:"10%", sort: true},
            {field:"NAME", align: "center",title:"名称",width:"15%", sort: true},
            {field:"content", align: "center",title:"简介",width:"25%"},
            {field:"div_tel", align: "center",title:"联系电话",width:"25%"},
    ...
    table.on('toolbar(text)', function(obj){
        ...
        if(layEvent === 'add'){
            layer.open({
                ...
                shade: 0.8,
                area: ['480px', '90%'],
                content: 'add_ks',//这里content是一个普通的String
            });
        }
    });
    //监听行
            ...
            layer.confirm('真的删除该科室么', function(index){
              ...
              layer.open({
                  ...
                  success: function(layero, index){
                      ...
                      body.find("[name=div_tel]").val(data.div_tel);
                  },
                  end: function(){
